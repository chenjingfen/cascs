            ...
            this.img.onclick = function () {
                ...
                if (this.diapo.isLoaded) {
                    ...
                    if (this.diapo.urlActive) {
                        ...
                        /*$('#leftContainer ul li').css('color', '#fff');
                        var title = this.diapo.title;
                        if (title) {
                            $('#' + title).css('color', 'red');
                            $('#leftContainer ul').animate({
                                scrolltop: $('#' + title).position().top+'px'
                            }, 'slow');
                        }*/
        ...
        if (this.isLoaded) {
         ...
         var width = w, height = h;
          if (width > 150) {
            ...
            this.css.left = Math.round(nw + x * p - width * .5) + 'px';
            this.css.top = Math.round(nh + y * p - height * .5) + 'px';
            this.css.width = Math.round(width) + 'px';
            this.css.height = Math.round(height) + 'px';


       /*    var width=parseInt(Math.random()*60+60),
             height=parseInt(Math.random()*80+80);
